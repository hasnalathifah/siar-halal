    ...
    if (resp.length!=0){
        arButton.push(
            <>
                ...
                <Link href={{pathname: 'https://siar-halal-ar.vercel.app/ar', query: {str}}} type="button" className=" text-center mt-8 relative w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-4 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Mulai navigasi AR</Link>
                <Link href={"https://hadziq.8thwall.app/siarhalal?destlat=" + dLat + "&destlon=" + dLon + "&mode=" + mode +'&id_user='+user_id} type="button" className=" text-center relative w-full text-white bg-teal-600 hover:bg-teal-700 focus:ring-4 focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-4 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Mulai navigasi 3D Map</Link>
            </>
        )
        console.log(resp)
    }
